classdef (CaseInsensitiveProperties) IReactors < DSS_MATLAB.Base
    ...
    methods
        ...
        function result = get.AllNames(obj)
            ...
            result = obj.apiutil.get_string_array('Reactors_Get_AllNames');
        end

        function result = get.Count(obj)
            % Number of Reactor objects
            result = calllib(obj.libname, 'Reactors_Get_Count');
        end

        function result = get.First(obj)
            % Set first object of Reactor; returns 0 if none.
            result = calllib(obj.libname, 'Reactors_Get_First');
        end

        function result = get.Name(obj)
            % Get/sets the name of the current active Reactor
            result = calllib(obj.libname, 'Reactors_Get_Name');
        end
        function obj = set.Name(obj, Value)
            calllib(obj.libname, 'Reactors_Set_Name', Value);
            obj.CheckForError();
        end

        function result = get.Next(obj)
            % Sets next Reactor active; returns 0 if no more.
            result = calllib(obj.libname, 'Reactors_Get_Next');
        end

        function result = get.idx(obj)
            % Get/set active Reactor by index;  1..Count
            result = calllib(obj.libname, 'Reactors_Get_idx');
        end
        function obj = set.idx(obj, Value)
            calllib(obj.libname, 'Reactors_Set_idx', Value);
            obj.CheckForError();
        end
        ...
        function result = get.Bus1(obj)
            ...
            result = calllib(obj.libname, 'Reactors_Get_Bus1');
            obj.CheckForError();
        end
        function obj = set.Bus1(obj, Value)
            calllib(obj.libname, 'Reactors_Set_Bus1', Value);
            obj.CheckForError();
        end
        ...
        function result = get.Bus2(obj)
            ...
            result = calllib(obj.libname, 'Reactors_Get_Bus2');
            obj.CheckForError();
        end
        function obj = set.Bus2(obj, Value)
            calllib(obj.libname, 'Reactors_Set_Bus2', Value);
            obj.CheckForError();
        end
        ...
        function result = get.LCurve(obj)
            ...
            result = calllib(obj.libname, 'Reactors_Get_LCurve');
            obj.CheckForError();
        end
        function obj = set.LCurve(obj, Value)
            calllib(obj.libname, 'Reactors_Set_LCurve', Value);
            obj.CheckForError();
        end
        ...
        function result = get.RCurve(obj)
            ...
            result = calllib(obj.libname, 'Reactors_Get_RCurve');
            obj.CheckForError();
        end
        function obj = set.RCurve(obj, Value)
            calllib(obj.libname, 'Reactors_Set_RCurve', Value);
            obj.CheckForError();
        end
        ...
        function result = get.Rmatrix(obj)
            ...
            calllib(obj.libname, 'Reactors_Get_Rmatrix_GR');
            obj.CheckForError();
            result = obj.apiutil.get_float64_gr_array();
        end
        function obj = set.Rmatrix(obj, Value)
            calllib(obj.libname, 'Reactors_Set_Rmatrix', Value, numel(Value));
            obj.CheckForError();
        end
        ...
        function result = get.Xmatrix(obj)
            ...
            calllib(obj.libname, 'Reactors_Get_Xmatrix_GR');
            obj.CheckForError();
            result = obj.apiutil.get_float64_gr_array();
        end
        function obj = set.Xmatrix(obj, Value)
            calllib(obj.libname, 'Reactors_Set_Xmatrix', Value, numel(Value));
            obj.CheckForError();
        end
        ...
        function result = get.Z(obj)
            ...
            calllib(obj.libname, 'Reactors_Get_Z_GR');
            obj.CheckForError();
            result = obj.apiutil.get_float64_gr_array();
        end
        function obj = set.Z(obj, Value)
            calllib(obj.libname, 'Reactors_Set_Z', Value, numel(Value));
            obj.CheckForError();
        end
        ...
        function result = get.Z1(obj)
            ...
            calllib(obj.libname, 'Reactors_Get_Z1_GR');
            obj.CheckForError();
            result = obj.apiutil.get_float64_gr_array();
        end
        function obj = set.Z1(obj, Value)
            calllib(obj.libname, 'Reactors_Set_Z1', Value, numel(Value));
            obj.CheckForError();
        end
        ...
        function result = get.Z2(obj)
            ...
            calllib(obj.libname, 'Reactors_Get_Z2_GR');
            obj.CheckForError();
            result = obj.apiutil.get_float64_gr_array();
        end
        function obj = set.Z2(obj, Value)
            calllib(obj.libname, 'Reactors_Set_Z2', Value, numel(Value));
            obj.CheckForError();
        end
        ...
        function result = get.Z0(obj)
            ...
            calllib(obj.libname, 'Reactors_Get_Z0_GR');
            obj.CheckForError();
            result = obj.apiutil.get_float64_gr_array();
        end
        function obj = set.Z0(obj, Value)
            calllib(obj.libname, 'Reactors_Set_Z0', Value, numel(Value));
            obj.CheckForError();
        end
    end
end