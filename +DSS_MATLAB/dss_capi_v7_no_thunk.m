...
fcns.thunkname{fcnNum}='doublecstringint32Thunk';fcns.name{fcnNum}='CktElement_Get_Variable'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='double'; fcns.RHS{fcnNum}={'cstring', 'int32'};fcnNum=fcnNum+1;
% double CktElement_Get_Variablei ( int32_t Idx , int32_t Code ); 
fcns.thunkname{fcnNum}='doubleint32int32Thunk';fcns.name{fcnNum}='CktElement_Get_Variablei'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='double'; fcns.RHS{fcnNum}={'int32', 'int32'};fcnNum=fcnNum+1;
